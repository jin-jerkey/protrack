...
export default function Sidebar({ user }: { user?: { nom: string; email: string } }) {
  ...
  return (
    <aside className="h-screen bg-gray-900 flex flex-col justify-between shadow-xl border-r border-gray-800 w-72 md:w-60 sm:w-20 transition-all duration-300">
      <div>
        {/* Logo */}
