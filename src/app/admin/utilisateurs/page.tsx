...
export default function UtilisateursAdminPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editId ? `http://localhost:5000/api/utilisateur/${editId}` : 'http://localhost:5000/api/utilisateur/';
      const body = { ...form };
      ...
      if (editId && !form.password) {
        delete body.password; // Ne pas envoyer si vide en modification
      }
